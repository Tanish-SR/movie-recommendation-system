...
def get_text(event=None):
    ...
    pygame.mixer.music.load('music/button-3.wav')
    pygame.mixer.music.play()
    text_widget = Text(frame, font='Courier 13 italic', cursor='arrow', bg='#FFB190', height=11, width=60)
...
label1 = Label(frame, font='Courier 13 italic', text='Select a Movie/TV Show/Documentary!', height=2, width=65,
               bg='black', highlightthickness=2, highlightbackground="black")
movie_data = ims.get_movie_data()  
...
instructions_text = Text(frame, font='Courier 13 italic', cursor='arrow', bg='red', height=11, width=60)
